...
export class BaseMigration1655656225073 implements MigrationInterface {
    name = 'BaseMigration1655656225073'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`addresses\` (\`id\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`alias\` varchar(255) NULL, \`name\` varchar(255) NOT NULL, \`number\` varchar(255) NULL, \`zip_code\` varchar(255) NOT NULL, \`city\` varchar(255) NOT NULL, \`federative_unity\` varchar(255) NOT NULL, \`country\` varchar(255) NOT NULL DEFAULT 'Brasil', \`user_id\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
